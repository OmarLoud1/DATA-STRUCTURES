...
public class Test {
    ...
    public static void main(String[] args){
        DoubleTreePhBook tree = new DoubleTreePhBook();
        ...
        System.out.println("marks' number is: "+tree.PhBNameSearch("mark"));

        //searches for a name that has more than one number
        System.out.println("People called omar have those numbers: " +tree.PhBNameSearch("omar"));
        ...
        //Number search
        System.out.println("the name associated with 3150001 is : "+tree.PhBPhoneSearch("3150001"));
